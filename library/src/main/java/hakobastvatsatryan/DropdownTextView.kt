...
class DropdownTextView : LinearLayout {
    ...
    private fun readBuilder(builder: Builder) {
        ...
        contentText =
            if (builder.contentTextRes > 0) resources.getString(builder.contentTextRes) else null
        ...
        linkTextColor = if (builder.linkTextColorRes > 0) ContextCompat.getColor(
            context,
            builder.linkTextColorRes
        ) else null
        ...
        panelPaddingRes =
            if (builder.panelPaddingRes == -1) R.dimen.panel_default_padding else builder.panelPaddingRes
        contentPaddingRes =
            if (builder.contentPaddingRes == -1) R.dimen.content_default_padding else builder.contentPaddingRes

        arrowDrawableRes =
            if (builder.arrowDrawableRes == -1) R.drawable.ic_arrow else builder.arrowDrawableRes
